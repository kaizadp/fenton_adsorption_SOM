...
ggplot(sorbed_temp[sorbed_temp$adsorbed=="sorbed"&(sorbed_temp$Class=="Carbohydrate-like"|sorbed_temp$Class=="Lignin-like"),], aes(x = O, fill = adsorbed))+
  geom_histogram(binwidth = 1)+
