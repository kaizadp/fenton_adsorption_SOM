...
```{r native_van_krev, fig.cap="native SOM", fig.width=12, fig.height=6}
percentile %>% 
...
```{r fenton_van_krev, fig.cap="fenton SOM", fig.width=12, fig.height=6}
...
```{r fenton, fig.cap="fenton loss", fig.width=8, fig.height=8}
...
```{r fenton_oxygen2, fig.cap="fenton  vs. no. of oxygens", fig.width=8, fig.height=8}
