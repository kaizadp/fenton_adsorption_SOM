...
```{r fenton_combined, fig.width=9, fig.height=5}
library(patchwork)
gg_loss2 + gg_loss_o
...
gg_vankrev(sorbed[!sorbed$adsorbed=="new",], aes(x = OC, y = HC, color=adsorbed))+
...
```{r goethite_sorbed2, fig.width=5, fig.height=6}
