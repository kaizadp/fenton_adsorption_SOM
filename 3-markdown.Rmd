...
```{r native_van_krev, fig.cap="native SOM", fig.width=10, fig.height=5}
master_hcoc %>% 
...
```{r fenton_van_krev, fig.cap="fenton SOM", fig.width=10, fig.height=5}
...
gg_vankrev(fentonloss[fentonloss$loss=="lost"|fentonloss$loss=="gained",], 
...
```{r goethite_vk, fig.cap="native SOM", fig.width=10, fig.height=5}
# set order of levels
sorbed %>% 
...
```{r sorbed_groups, fig.cap="", fig.width=9, fig.height=7, include=FALSE}
sorbed_relabund %>% 
...
```{r goethite_vk2, fig.cap="native SOM", fig.width=5, fig.height=5, include=FALSE}
# set order of levels
sorbed %>% 
  dplyr::mutate(fenton=factor(fenton, levels = c("PreFenton","PostFenton")))->sorbed
...
```{r goethite_sorbed2, fig.cap="native SOM", fig.width=5, fig.height=6}
