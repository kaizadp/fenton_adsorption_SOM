...
```{r native van krev, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="native SOM", fig.width=12, fig.height=6,fig.path = "images/"}
percentile %>% 
...
```{r fenton van krev, echo=FALSE, warning=FALSE,message=FALSE,fig.cap="native SOM", fig.width=12, fig.height=6,fig.path = "images/"}
...
```{r fenton_oxygen, eval=FALSE,echo=FALSE, warning=FALSE,message=FALSE,fig.cap="native SOM", fig.width=8, fig.height=8,fig.path = "images/"}
...
```{r fenton_oxygen2, eval=TRUE,echo=FALSE, warning=FALSE,message=FALSE,fig.cap="native SOM", fig.width=8, fig.height=8,fig.path = "images/"}
fenton_el = merge(fentonloss, meta_elements, by = "Mass", all.x=TRUE)
...
```{r sorbed_O, eval=TRUE,echo=FALSE, warning=FALSE,message=FALSE,fig.cap="native SOM", fig.width=9, fig.height=7,fig.path = "images/"}
...
sorbed %>% 
  ...
  dplyr::mutate(cumsum = cumsum(counts))->sorbed_el
